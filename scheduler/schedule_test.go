...
func TestScheduleNext(t *testing.T) {
	for i, testcase := range []struct {
		...
		{scheduler.NewSchedule(2000, 1, 1, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(0, 1, 1, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(2000, 0, 1, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(2000, 1, 0, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(0, 0, 1, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(2000, 0, 0, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(0, 1, 0, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		...
		{scheduler.NewSchedule(0, 0, 0, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		{scheduler.NewSchedule(0, 0, 0, nil), "1900/12/15 12:00:00", "1900/12/15 12:00:01"},
		{scheduler.NewSchedule(0, 0, 0, nil), "2000/02/15 12:00:00", "2000/02/15 12:00:01"},
	} {
...
func TestISOWeekScheduleNext(t *testing.T) {
	for i, testcase := range []struct {
		...
		{scheduler.ISOWeekSchedule(2000, 1, utils.Ptr(time.Monday), nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(0, 1, utils.Ptr(time.Monday), nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(2000, 0, utils.Ptr(time.Monday), nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(2000, 1, nil, nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(0, 0, utils.Ptr(time.Monday), nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(2000, 0, nil, nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(0, 1, nil, nil), "2000/01/03 12:00:00", "2000/01/03 12:00:01"},
		...
		{scheduler.ISOWeekSchedule(0, 0, nil, nil), "2000/01/01 12:00:00", "2000/01/01 12:00:01"},
		{scheduler.ISOWeekSchedule(0, 0, nil, nil), "1900/12/15 12:00:00", "1900/12/15 12:00:01"},
		{scheduler.ISOWeekSchedule(0, 0, nil, nil), "2000/02/15 12:00:00", "2000/02/15 12:00:01"},
	} {
		if res := testcase.s.Next(parse(testcase.t)).Format(format); res != testcase.next {
			t.Errorf("#%d expected %v; got %v", i, testcase.next, res)
		} else if next := parse(testcase.next); !next.IsZero() && !testcase.s.IsMatched(next) {
